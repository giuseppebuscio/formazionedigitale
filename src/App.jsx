...
const App = () => {
  ...
  const educationalTools = [
    ...
    // Piattaforme Educative Italiane
    { name: "WeSchool", url: "https://library.weschool.com/", description: "Piattaforma educativa italiana con 7000+ lezioni gratuite", subjects: ["Informatica", "Storia", "Italiano", "Scienze", "Inglese", "Musica", "Matematica", "Fisica", "Chimica", "Biologia", "Geografia", "Arte", "Filosofia", "Lingue", "Altro"], platform: "Web", pricing: "Gratuito", tags: ["Italiano", "Lezioni", "Video", "Multidisciplinare", "Gratuito"] },
    { name: "RAI Scuola", url: "https://www.raiscuola.rai.it/", description: "Contenuti educativi RAI per tutte le materie scolastiche", subjects: ["Fisica", "Matematica", "Scienze", "Tecnologia", "Italiano", "Inglese", "Musica", "Storia", "Geografia", "Arte", "Filosofia", "Lingue", "Chimica", "Biologia", "Altro"], platform: "Web", pricing: "Gratuito", tags: ["RAI", "Italiano", "TV", "Video", "Multidisciplinare", "Gratuito"] },
    { name: "Matematicamente", url: "https://lezioni.matematicamente.it/home-videolezioni.html", description: "Video lezioni di matematica e scienze per scuole superiori e università", subjects: ["Matematica", "Scienze", "Chimica", "Fisica", "Biologia", "Altro"], platform: "Web", pricing: "Gratuito", tags: ["Matematica", "Video Lezioni", "Italiano", "Università", "Superiori"] },
    { name: "Matematika", url: "https://www.matematika.it//index.php", description: "Progetto Matematika: risorse complete per matematica, fisica, chimica e scienze", subjects: ["Matematica", "Fisica", "Scienze", "Chimica", "Biologia", "Geografia", "Inglese", "Altro"], platform: "Web", pricing: "Gratuito", tags: ["Matematica", "Italiano", "Test", "Enigmi", "Giochi", "Università"] },
    { name: "KMZero", url: "https://it.pearson.com/kilometro-zero/secondaria-2-grado.html", description: "Piattaforma Pearson per Didattica Digitale Integrata con video, esercizi e Google Moduli", subjects: ["Inglese", "Matematica", "Scienze", "Chimica", "Fisica", "Italiano", "Storia", "Geografia", "Arte", "Filosofia", "Lingue", "Biologia", "Altro"], platform: "Web", pricing: "Gratuito", tags: ["Pearson", "DDI", "Google Classroom", "Video", "Esercizi", "Superiori"] },
    ...
    { name: "Coggle", url: "https://coggle.it/", description: "Creazione di mappe mentali e diagrammi di flusso online", subjects: ["Altro"], platform: "Web", pricing: "Freemium", tags: ["Mappe Mentali", "Diagrammi", "Collaborazione", "Creatività", "Organizzazione"] },
